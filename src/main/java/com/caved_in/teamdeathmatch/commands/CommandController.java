...
public class CommandController implements CommandExecutor {
	...
	public static @interface CommandHandler {
		...
		String permissionMessage() default "[Tunnels Network] You do not have permission for this command, if you believe this is an error please fill out a " +
				"bug report on our forums.";
	}
	...
	public static @interface SubCommandHandler {
		...
		String permissionMessage() default "[Vaecon Network] You do not have permission for this command, if you believe this is an error please fill out a " +
				"bug report on our forums.";
	}
			...
			if (subCommand != null) {
				...
				if (subHandler != null && subMethod != null) {
					...
					try {
						...
						sender.sendMessage(ChatColor.RED + "[Tunnels Network] There was an error while processing this command; Please check the syntax used, " +
								"and if it persists fill out a bug report on our forums.");
						e.printStackTrace();
					}
					return true;
				}
